...
asmlinkage long interceptor(struct pt_regs reg) {
    ...
    if (monitored) {
        log_message((unsigned int)current_pid, syscall,
                    (unsigned long)(unsigned int)reg.bx,
                    (unsigned long)(unsigned int)reg.cx,
                    (unsigned long)(unsigned int)reg.dx,
                    (unsigned long)(unsigned int)reg.si,
                    (unsigned long)(unsigned int)reg.di,
                    (unsigned long)(unsigned int)reg.bp);
    }
